...
func main() {
	...
	db.AddQueryHook[model.Company, model.CompanyFiltersInput, model.CompanyOrder](&dborm, db.QueryCompany, QueryCompanyHook{})
	db.AddAddHook[model.Company, model.CompanyInput, model.AddCompanyPayload](&dborm, db.AddCompany, AddCompanyHook{})
	db.AddUpdateHook[model.Company, model.UpdateCompanyInput, model.UpdateCompanyPayload](&dborm, db.UpdateCompany, UpdateCompanyHook{})
	db.AddDeleteHook[model.CompanyFiltersInput, model.DeleteCompanyPayload](&dborm, db.DeleteCompany, DeleteCompanyHook{})
	dborm.Init()
